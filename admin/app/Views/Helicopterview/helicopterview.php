...
<div class="accordion-body collapse show border border-top-0 text-sm" id="panel-body-1" data-parent="#accordion">
	...
	$mtmrate = 1;
	$potential_portfolio_1 = ($hedgedpositionamount * $hedgedpositionrate) + ($openpositionamount * $mtmrate);
	...
	$mtmrate = 1;
	$potential_portfolio_2 = ($hedgedpositionamount * $hedgedpositionrate) + ($openpositionamount * $mtmrate);
	...
	$mtmrate = 1;
	$potential_portfolio_3 = ($hedgedpositionamount * $hedgedpositionrate) + ($openpositionamount * $mtmrate);
	...
	$mtmrate = 1;
	$potential_portfolio_4 = ($hedgedpositionamount * $hedgedpositionrate) + ($openpositionamount * $mtmrate);
	...
	. $targetrate_sum  . "</td><td>"
	. $hedged_amount_sum  . "</td><td>"
	. $hedgedperctage_sum  . "</td><td>"
	. $hedged_sum  . "</td><td>"
	...
	$openpositionamount = $value["Q1"] != "" ? explode(",", $value["Q1"])[0] - explode(",", $value["Q1"])[3] : 0;
	$mtmrate = 1;
	$potential_portfolio = ($hedgedpositionamount * $hedgedpositionrate) + ($openpositionamount * $mtmrate);

	echo "<tr>";	
	echo "<td>Q1</td><td>" . ($value["Q1"] != "" ? explode(",", $value["Q1"])[0] : "-")  . "</td>
	<td>" . ($value["Q1"] != "" ? explode(",", $value["Q1"])[0] * explode(",", $value["Q1"])[2] : "-")  . "</td><td>"
	. ($value["Q1"] != "" ? explode(",", $value["Q1"])[2] : "-")  . "</td><td>"
	. ($value["Q1"] != "" ? explode(",", $value["Q1"])[3] : "-")  . "</td><td>"
	. ($value["Q1"] != "" ? (explode(",", $value["Q1"])[3] / explode(",", $value["Q1"])[0])*100 : "-")  . "</td><td>"
	. ($value["Q1"] != "" ? explode(",", $value["Q1"])[1] : "-")  . "</td><td>"
	. ($value["Q1"] != "" ? explode(",", $value["Q1"])[0] - explode(",", $value["Q1"])[3] : "-")  . "</td><td>"
	. ($value["Q1"] != "" ? "Mtm rate" : "-")  . "</td><td>"
	...
	. ($value["Q2"] != "" ? explode(",", $value["Q2"])[2] : "-")  . "</td><td>"
	. ($value["Q2"] != "" ? explode(",", $value["Q2"])[3] : "-")  . "</td><td>"
	. ($value["Q2"] != "" ? (explode(",", $value["Q2"])[3] / explode(",", $value["Q2"])[0])*100 : "-")  . "</td><td>"
	. ($value["Q2"] != "" ? explode(",", $value["Q2"])[1] : "-")  . "</td><td>"
	. ($value["Q2"] != "" ? explode(",", $value["Q2"])[0] - explode(",", $value["Q2"])[3] : "-")  . "</td><td>"
	. ($value["Q2"] != "" ? "Mtm rate" : "-")  . "</td><td>"
	...
	. ($value["Q3"] != "" ? explode(",", $value["Q3"])[2] : "-")  . "</td><td>"
	. ($value["Q3"] != "" ? explode(",", $value["Q3"])[3] : "-")  . "</td><td>"
	. ($value["Q3"] != "" ? (explode(",", $value["Q3"])[3] / explode(",", $value["Q3"])[0])*100 : "-")  . "</td><td>"
	. ($value["Q3"] != "" ? explode(",", $value["Q3"])[1] : "-")  . "</td><td>"
	. ($value["Q3"] != "" ? explode(",", $value["Q3"])[0] - explode(",", $value["Q3"])[3] : "-")  . "</td><td>"
	. ($value["Q3"] != "" ? "Mtm rate" : "-")  . "</td><td>"
	...
	. ($value["Q4"] != "" ? explode(",", $value["Q4"])[2] : "-")  . "</td><td>"
	. ($value["Q4"] != "" ? explode(",", $value["Q4"])[3] : "-")  . "</td><td>"
	. ($value["Q4"] != "" ? (explode(",", $value["Q4"])[3] / explode(",", $value["Q4"])[0])*100 : "-")  . "</td><td>"
	. ($value["Q4"] != "" ? explode(",", $value["Q4"])[1] : "-")  . "</td><td>"
	. ($value["Q4"] != "" ? explode(",", $value["Q4"])[0] - explode(",", $value["Q4"])[3] : "-")  . "</td><td>"
	. ($value["Q4"] != "" ? "Mtm rate" : "-")  . "</td><td>"
