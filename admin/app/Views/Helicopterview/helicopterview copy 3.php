...
<div class="card-body">
	...
	// first value
	$avg_1 = ($value["Q1"] != "" ?  1 : 0);
	$hedgedpositionamount = $value["Q1"] != "" ? explode(",", number_format($value["Q1"])[3], 2, '.', ','): 0;
	...
	echo "<tr>";	
	echo "<td>Exports</td><td>" . number_format($exports_sum, 2, '.', ',')   . "</td>
	...
	. number_format($expotrate, 2, '.', ',')  . "</td><td>"
...
<div class="card-body">
	...
	echo "<tr>";	
	echo "<td>Imports</td><td>" . number_format($exports_sum, 2, '.', ',')   . "</td>
	<td>" . number_format($targetvalue_sum, 2, '.', ',')  . "</td><td>"
	. number_format($targetrate_sum, 4, '.', ',')  . "</td><td>"
	. number_format($hedgedperctage_sum, 4, '.', ',')  . "</td><td>"
	. number_format($hedged_amount_sum, 2, '.', ',')   . "</td><td>"
