...
<div class="form-group" id="inrinput<?=$i?>" style="display: none;"><label class="form-label" id="inrinputlabelvalue<?=$i?>">INR Target Value</label>
        <input type="number" id="inr_field_valueid<?=$i?>"  value="0" step=".0001" oninput='validatedigit(this)' name="inr_field_value[]"  placeholder="INR Value" class="form-control">
</div>
</div>
