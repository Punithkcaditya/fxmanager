...
<div class="form-group"><label class="form-label"><?php echo $pade_title6 ?></label>
    ...
    <div class="col-md-3 col-sm-12">
        ...
        <input id="amountinfc" type="number" name="amountinfc[]" placeholder="Amount in FC" class="form-control"  required/>
        </div>
</div>
<div class="col-md-3 col-sm-12">
...
<input id="targetrat" type="number" name="targetrat[]" min="0" value="0" step=".0001" placeholder="Target Rat" class="form-control"  required/>
</div>
</div>
...
<div class="col-md-3 col-sm-12">
<div class="form-group" id="inrinput<?=$i?>" style="display: none;"><label class="form-label" id="inrinputlabelvalue">INR Target Value</label>
        <input type="number" id="inr_field_valueid<?=$i?>" min="0" value="0" step=".0001" name="inr_field_value[]" placeholder="INR Value" class="form-control">
</div>
</div>
